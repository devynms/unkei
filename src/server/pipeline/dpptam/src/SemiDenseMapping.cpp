               ...
               semidense_mapper->previous_images = semidense_mapper->num_cameras_mapping_th/2+1+1;
                ...
                if (semidense_mapper->do_var_mapping > 0.5)
                {
                    ...
                    if (print_depth_maps > 0.5)
                    {
                        ...
                        sprintf (write_depth_map,(ros::package::getPath("unkei")+"/src/results_depth_maps/depth_keyframe%d_xFiltered.png").c_str(),num_keyframes);
                   ...
                   {
                        char buffer[150];
                        sprintf (buffer,(ros::package::getPath("unkei")+"/src/map_and_poses/MAP%d.ply").c_str(),num_keyframes);
